...
architecture comportamento of semaforoPadrao is
	...
	constant GREEN_TIMEP : natural := 10;   -- Tempo em segundos para o estado verde
	constant YELLOW_TIME : natural := 3;   -- Tempo em segundos para o estado amarelo
	constant GREEN_TIMES : natural := 5;   -- Tempo em segundos para o estado verde
